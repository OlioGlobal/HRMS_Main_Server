...
const ROLE_DEFINITIONS = {
  ...
  'hr-manager': {
    ...
    permissions: [
      ...
      // Appraisals — full access
      { key: 'appraisal_cycles:view',      scope: 'global' },
      { key: 'appraisal_cycles:create',    scope: 'global' },
      { key: 'appraisal_cycles:update',    scope: 'global' },
      { key: 'appraisal_cycles:delete',    scope: 'global' },
      { key: 'appraisal_records:view',     scope: 'global' },
      { key: 'appraisal_records:update',   scope: 'global' },
      { key: 'appraisal_records:finalize', scope: 'global' },
      { key: 'appraisal_records:export',   scope: 'global' },
      { key: 'appraisal_goals:view',       scope: 'global' },
      { key: 'appraisal_goals:create',     scope: 'global' },
      { key: 'appraisal_goals:update',     scope: 'global' },
      { key: 'appraisal_goals:approve',    scope: 'global' },
      { key: 'appraisal_goals:delete',     scope: 'global' },
  ...
  'manager': {
    ...
    permissions: [
      ...
      { key: 'holidays:view',                     scope: 'global' },
      // Appraisals — manage team
      { key: 'appraisal_cycles:view',              scope: 'team'   },
      { key: 'appraisal_records:view',             scope: 'team'   },
      { key: 'appraisal_records:update',           scope: 'team'   },
      { key: 'appraisal_goals:view',               scope: 'team'   },
      { key: 'appraisal_goals:approve',            scope: 'team'   },
  ...
  'employee': {
    ...
    permissions: [
      ...
      // Appraisals — own
      { key: 'appraisal_cycles:view',             scope: 'self' },
      { key: 'appraisal_records:view',            scope: 'self' },
      { key: 'appraisal_goals:view',              scope: 'self' },
      { key: 'appraisal_goals:create',            scope: 'self' },
      { key: 'appraisal_goals:update',            scope: 'self' },
      // Documents — own
